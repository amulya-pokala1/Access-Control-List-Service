...
CREATE TABLE `user` (
  ...
  `password` varchar(45) NOT NULL,
  `mail_id` varchar(254) DEFAULT NULL,
  PRIMARY KEY (`user_id`)
...
INSERT INTO `user` VALUES (1,'xyz','READ_ONLY',NULL),(2,'x','READ_ONLY',NULL),(3,'xyz','READ_ONLY',NULL),(4,'xyz','READ_ONLY',NULL),(5,'xyz','READ_ONLY',NULL);
...
-- Dump completed on 2018-01-17 12:10:10
