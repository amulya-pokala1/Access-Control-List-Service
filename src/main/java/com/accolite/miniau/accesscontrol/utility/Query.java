...
public class Query {
	...
	public static final String GETADMINIDFROMURI = "SELECT ADMIN_ID FROM ADMIN_PASSWORD_URI WHERE URI=?";
	public static final String GETADMINIDUSINGEMAIL = "SELECT ADMIN_ID FROM ADMIN WHERE MAIL_ID = ?";
	public static final String GETADMINNAME = "SELECT ADMIN_NAME FROM ADMIN WHERE ADMIN_ID = ?";
	public static final String AUTHENTICATIE = "SELECT ADMIN_ID FROM ADMIN WHERE MAIL_ID=? AND PASSKEY=?";
	public static final String GETALLADMINS = "SELECT * FROM ADMIN";
	public static final String ISADMIN = "SELECT COUNT(*) FROM ADMIN WHERE MAIL_ID=?";
	...
	/** THE Constant GETUSERSNOTINGROUP. */
	public static final String GETUSERSNOTINGROUP = "SELECT * FROM USER WHERE USER_ID NOT IN (SELECT USER_ID FROM USER_GROUP WHERE GROUP_ID=?)";

	/** THE Constant DELETEGROUP. */
	public static final String DELETEGROUP = "DELETE FROM ACL.GROUP WHERE GROUP_ID=?";
	...
	public static final String GETUSERPERMISSIONS = "SELECT * FROM PERMISSION WHERE PERMISSION_ID IN (SELECT PERMISSION_ID FROM USER_PERMISSION WHERE USER_ID=?)";
