...
public class Query {
	...
	// SUPERADMINDAO
	public static final String AUTHENTICATESUPERADMIN = "SELECT ID FROM SUPER_ADMIN WHERE MAIL_ID=? AND PASSKEY=?";
	public static final String UPDATESUPERADMIN = "UPDATE SUPER_ADMIN SET NAME=? MAIL_ID=? WHERE ID= 1";
}
